...
test:
	mkdir -p coverage
	go test -coverprofile=coverage/metrics.out ./pkg/query-service/app/metrics/...
	gcov2lcov -infile=coverage/metrics.out -outfile=coverage/metrics.lcov
	go test -coverprofile=coverage/cache.out ./pkg/query-service/cache/...
	gcov2lcov -infile=coverage/cache.out -outfile=coverage/cache.lcov
	go test -coverprofile=coverage/app.out ./pkg/query-service/app/...
	gcov2lcov -infile=coverage/app.out -outfile=coverage/app.lcov
	go test -coverprofile=coverage/querier.out ./pkg/query-service/app/querier/...
	gcov2lcov -infile=coverage/querier.out -outfile=coverage/querier.lcov
	go test -coverprofile=coverage/converter.out ./pkg/query-service/converter/...
	gcov2lcov -infile=coverage/converter.out -outfile=coverage/converter.lcov
	go test -coverprofile=coverage/formatter.out ./pkg/query-service/formatter/...
	gcov2lcov -infile=coverage/formatter.out -outfile=coverage/formatter.lcov
	go test -coverprofile=coverage/integration.out ./pkg/query-service/tests/integration/...
	gcov2lcov -infile=coverage/integration.out -outfile=coverage/integration.lcov
	go test -coverprofile=coverage/rules.out ./pkg/query-service/rules/...
	gcov2lcov -infile=coverage/rules.out -outfile=coverage/rules.lcov
	go test -coverprofile=coverage/collectorsimulator.out ./pkg/query-service/collectorsimulator/...
	gcov2lcov -infile=coverage/collectorsimulator.out -outfile=coverage/collectorsimulator.lcov
	go test -coverprofile=coverage/postprocess.out ./pkg/query-service/postprocess/...
	gcov2lcov -infile=coverage/postprocess.out -outfile=coverage/postprocess.lcov
